...
export function defaultGroupOf(ruleId = "") {
...
export function normalizeKpis(rawKpis, opts = {}) {
...
export function computeImpactGap(kpis) {
 ...
 */
export function computeBreakdown(kpis, opts = {}) {
...
export function buildTopFixlist(kpis, opts = {}) {
